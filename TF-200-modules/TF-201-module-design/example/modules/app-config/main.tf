# TF-201: Module Design — Child Module: app-config
#
# This child module manages a set of application configuration files.
# It demonstrates the standard module structure:
#   - variables.tf  (inputs)
#   - main.tf       (resources)
#   - outputs.tf    (outputs)
#
